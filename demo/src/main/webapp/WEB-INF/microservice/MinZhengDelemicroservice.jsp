        ...
        <div class="weui-grids" id="originMicroservice">
            <c:forEach items="${fList}" var="feature">
                <c:if test="${feature.features=='MinzhengDongTai'}">
                    <a href="javascript:;" class="weui-grid" id="MinzhengDongTai" <c:if test="${feature.status=='false'}">style="display:none"</c:if>>
                ...
                <c:if test="${feature.features=='TonzhiGongGao'}">
                    <a href="javascript:;" class="weui-grid" id="TonzhiGongGao" <c:if test="${feature.status=='false'}">style="display:none"</c:if>>
                        <div class="weui-grid__icon">
                ...
                <c:if test="${feature.features=='WangshangBanshi'}">
                    <a href="javascript:;" class="weui-grid" id="WangshangBanshi" <c:if test="${feature.status=='false'}">style="display:none"</c:if>>
                        <div class="weui-grid__icon">
                ...
                <c:if test="${feature.features=='MinzhengKanWu'}">
                    <a href="javascript:;" class="weui-grid" id="MinzhengKanWu" <c:if test="${feature.status=='false'}">style="display:none"</c:if>>
                        <div class="weui-grid__icon">
                ...
                <c:if test="${feature.features=='YouDaiFuXu'}">
                    <a href="javascript:;" class="weui-grid" id="YouDaiFuXu" <c:if test="${feature.status=='false'}">style="display:none"</c:if>>
                        <div class="weui-grid__icon">
                ...
                <c:if test="${feature.features=='TuiWuAnZhi'}">
                    <a href="javascript:;" class="weui-grid" id="TuiWuAnZhi" <c:if test="${feature.status=='false'}">style="display:none"</c:if>>
                        <div class="weui-grid__icon">
                ...
                <c:if test="${feature.features=='JiuZaiJuiZhi'}">
                    <a href="javascript:;" class="weui-grid" id="JiuZaiJuiZhi" <c:if test="${feature.status=='false'}">style="display:none"</c:if>>
                        <div class="weui-grid__icon">
                ...
                <c:if test="${feature.features=='TeKunGongYang'}">
                    <a href="javascript:;"  class="weui-grid" id="TeKunGongYang" <c:if test="${feature.status=='false'}">style="display:none"</c:if>>
