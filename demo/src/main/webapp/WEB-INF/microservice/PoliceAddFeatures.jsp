        ...
        <div class="weui-grids" id="originMicroservice">
            ...
            <c:forEach items="${policeList}" var="policeList">
                <c:if test="${policeList.fetaures=='ZhuHuChaXun'}">
                    ...
                    <a href="javascript:;" class="weui-grid" id="ZhuHuChaXun"  <c:if test="${policeList.status=='true'}">style="display:none"</c:if>>
                ...
                <c:if test="${policeList.fetaures=='PaiChuSuoInfo'}">
                    <a href="javascript:;" class="weui-grid" id="PaiChuSuoInfo" <c:if test="${policeList.status=='true'}">style="display:none"</c:if>>
                        <div class="weui-grid__icon">
                ...
                <c:if test="${policeList.fetaures=='AnQuanJanYi'}">
                    <a href="javascript:;" class="weui-grid" id="AnQuanJanYi" <c:if test="${policeList.status=='true'}">style="display:none"</c:if>>
                        <div class="weui-grid__icon">
                ...
                <c:if test="${policeList.fetaures=='XunRenQiShi'}">
                    <a href="javascript:;" class="weui-grid" id="XunRenQiShi" <c:if test="${policeList.status=='true'}">style="display:none"</c:if>>
                        <div class="weui-grid__icon">
                ...
                <c:if test="${policeList.fetaures=='WangShangHuiJian'}">
                    <a href="javascript:;" class="weui-grid" id="WangShangHuiJian" <c:if test="${policeList.status=='true'}">style="display:none"</c:if>>
                        <div class="weui-grid__icon">
                ...
                <c:if test="${policeList.fetaures=='XiaQuMinJing'}">
                    <a href="javascript:;" class="weui-grid" id="XiaQuMinJing" <c:if test="${policeList.status=='true'}">style="display:none"</c:if>>
                        <div class="weui-grid__icon">
                            <img src="/static/images/icon_nav_me.png" alt="">
                        </div>
                ...
                <c:if test="${policeList.fetaures=='YiJianBaoJing'}">
                    <a href="javascript:;" class="weui-grid" id="YiJianBaoJing"  <c:if test="${policeList.status=='true'}">style="display:none"</c:if>>
                        <div class="weui-grid__icon">
                ...
                <c:if test="${policeList.fetaures=='FangWuZuLin'}">
                    <a href="javascript:;" class="weui-grid" id="FangWuZuLin" <c:if test="${policeList.status=='true'}">style="display:none"</c:if>>
                        <div class="weui-grid__icon">
                            <img src="/static/images/icon_nav_toast.png" alt="">
                        </div>
                ...
                <c:if test="${policeList.fetaures=='ZhaoPingXinXi'}">
                    <a href="javascript:;" class="weui-grid" id="ZhaoPingXinXi" <c:if test="${policeList.status=='true'}"> style="display:none"</c:if>>
                        <div class="weui-grid__icon">
